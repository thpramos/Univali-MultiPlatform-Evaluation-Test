...
desired_caps = {
  caps: {
    ...
    app: "/Users/thiagoramos/code/univali/apps/app-release-xamarin.apk",
...
describe 'Basic React interactions' do
  ...
  it 'should send keys to search box and then check the value' do
    ...
    fab = @driver.find_element(:id, "br.univali.UnivaliTCC2:id/fab")
    fab.click


    row0 = @driver.find_element :xpath, "/hierarchy/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.ListView/android.widget.LinearLayout[1]"
    row0.click();
